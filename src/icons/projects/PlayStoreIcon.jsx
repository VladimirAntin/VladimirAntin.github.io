...
const PlayStoreIcon = ({width = 32, height = 32}) => {
  return (
    <svg
      viewBox="0 0 32 32"
      fill="none"
...
export default memo(PlayStoreIcon);
