...
const FrameworkIcon = ({width = 24, height = 24}) => {
  return (
    <svg
      id="Layer_5"
    ...
    >
      <g>
        <g>
          ...
          <g>
            <path
              d="m13.37 41.32c1.41 2.82.4 6.28-2.37 7.88-2.87 1.65-6.54.67-8.2-2.2-1.65-2.87-.67-6.54 2.2-8.2 2.87-1.65 6.54-.67 8.2 2.2.06.1.12.21.17.32z"
              fill="#ff826e"
            />
          </g>
          <g>
          ...
          <g>
            <path
              d="m8 15.54c1.91 1.1 2.57 3.55 1.46 5.46-1.1 1.91-3.55 2.57-5.46 1.46-1.91-1.1-2.57-3.55-1.46-5.46 1.1-1.91 3.55-2.57 5.46-1.46z"
              fill="#fcd770"
            />
          </g>
          <g>
            <path
              d="m32 2c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6 2.69-6 6-6z"
              fill="#ff826e"
            />
          </g>
          <g>
            <path
              d="m61.46 17c1.11 1.91.45 4.36-1.46 5.46-1.91 1.11-4.36.45-5.46-1.46-.04-.07-.08-.14-.11-.21-.95-1.87-.27-4.19 1.57-5.25 1.91-1.11 4.36-.45 5.46 1.46z"
              fill="#fcd770"
            />
          </g>
          <g>
            <path
              d="m50.63 41.32c.05-.11.11-.22.17-.32 1.66-2.87 5.33-3.85 8.2-2.2 2.87 1.66 3.85 5.33 2.2 8.2-1.66 2.87-5.33 3.85-8.2 2.2-2.77-1.6-3.78-5.06-2.37-7.88z"
              fill="#ff826e"
            />
          </g>
          <g>
          ...
          <g>
            <path
              d="m9.73 43c.55.96.23 2.18-.73 2.73s-2.18.23-2.73-.73c-.56-.96-.23-2.18.73-2.73.96-.56 2.18-.23 2.73.73z"
              fill="#fc6e51"
            />
          </g>
          <g>
            <path
              d="m57 42.27c.96.55 1.29 1.77.73 2.73-.55.96-1.77 1.28-2.73.73s-1.28-1.77-.73-2.73 1.77-1.29 2.73-.73z"
              fill="#fc6e51"
            />
          </g>
        </g>
        <g>
          <path d="m35 8c0-1.654-1.346-3-3-3s-3 1.346-3 3 1.346 3 3 3 3-1.346 3-3zm-4 0c0-.552.449-1 1-1s1 .448 1 1-.449 1-1 1-1-.448-1-1z" />
...
export default memo(FrameworkIcon);
