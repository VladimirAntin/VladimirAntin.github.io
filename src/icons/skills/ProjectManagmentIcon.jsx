...
const ProjectManagementIcon = ({width = 24, height = 24}) => {
  return (
    <svg
      height={height}
      viewBox="0 0 64 64"
    ...
    >
      <g id="Computer-Engineer-Gear-Monitor-Construction">
        <path
          d="m53 17v24h-50v-24a4 4 0 0 1 4-4h42a4 4 0 0 1 4 4z"
          fill="#5aaae7"
        />
        <path
          d="m53 41v4a4 4 0 0 1 -4 4h-42a4 4 0 0 1 -4-4v-4z"
          fill="#c6c5ca"
        />
        <path
          d="m53 17v12.53c-.17.05-.35.1-.53.15l-.47 3.32h-4l-.47-3.32a9.8 9.8 0 0 1 -2.62-1.09l-2.69 2.02-2.83-2.83 2.02-2.69a9.8 9.8 0 0 1 -1.09-2.62l-3.32-.47v-4l3.32-.47a9.427 9.427 0 0 1 1.04-2.53.405.405 0 0 1 .05-.09l-1.43-1.91h9.02a4 4 0 0 1 4 4z"
          fill="#3d9ae2"
        />
        <path
          d="m57.68 20.47a9.8 9.8 0 0 1 -1.09 2.62l2.02 2.69-2.83 2.83-2.69-2.02a.405.405 0 0 1 -.09.05 9.427 9.427 0 0 1 -2.53 1.04l-.47 3.32h-4l-.47-3.32a9.8 9.8 0 0 1 -2.62-1.09l-2.69 2.02-2.83-2.83 2.02-2.69a9.8 9.8 0 0 1 -1.09-2.62l-3.32-.47v-4l3.32-.47a9.427 9.427 0 0 1 1.04-2.53.405.405 0 0 1 .05-.09l-2.02-2.69 2.83-2.83 2.69 2.02a9.8 9.8 0 0 1 2.62-1.09l.47-3.32h4l.47 3.32a9.8 9.8 0 0 1 2.62 1.09l2.69-2.02 2.83 2.83-2.02 2.69a9.8 9.8 0 0 1 1.09 2.62l3.32.47v4z"
          fill="#ff9811"
        />
        <circle
          cx="48"
        ...
        />
        <path
          d="m39.41 57.59a1.955 1.955 0 0 1 .59 1.41 2.006 2.006 0 0 1 -2 2h-20a2.015 2.015 0 0 1 -2-2 2.006 2.006 0 0 1 2-2h20a1.955 1.955 0 0 1 1.41.59z"
          fill="#898890"
        />
        <path
          d="m36 57h-16l1-8h14z"
          fill="#acabb1"
        />
        <path
          d="m33 38.9v2.1h-24v-2.1a6 6 0 0 1 3.56-5.48l2.74-1.22 2.7-1.2v-2.68a6.946 6.946 0 0 1 -3.92-5.32h-1.08a2 2 0 0 1 0-4h1v-2a2.015 2.015 0 0 1 -2-2 2.006 2.006 0 0 1 2-2h14a2.015 2.015 0 0 1 2 2 2.006 2.006 0 0 1 -2 2v2h1a2 2 0 0 1 0 4h-1.08a6.952 6.952 0 0 1 -3.92 5.32v2.68l2.7 1.2 2.74 1.22a6 6 0 0 1 3.56 5.48z"
          fill="#3d9ae2"
        />
        <path
          d="m31 36.9v4.1h-9l-1.82-8.18.82-.82 3 1 .7-2.8 2.74 1.22a6 6 0 0 1 3.56 5.48z"
          fill="#1e81ce"
        />
        <path
          d="m27.41 11.59a1.955 1.955 0 0 1 .59 1.41 2.006 2.006 0 0 1 -2 2h-14a2.015 2.015 0 0 1 -2-2 2.006 2.006 0 0 1 2-2h14a1.955 1.955 0 0 1 1.41.59z"
          fill="#f7910c"
        />
        <path
          d="m26 11h-5v-5.91a5.984 5.984 0 0 1 4.91 4.91 5.47 5.47 0 0 1 .09 1z"
          fill="#ff9811"
        />
        <path
          d="m24.7 30.2-.7 2.8-3-1-1-2 2-1z"
          fill="#1a6fb0"
        />
        <path
          d="m20.18 32.82 1.82 8.18h-6l1.82-8.18 1.18 1.18z"
          fill="#ed1c24"
        />
        <path
          d="m21 5.09v5.91h-4v-7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1z"
          fill="#ffa733"
        />
        <path
          d="m20 30 1 2-.82.82-1.18 1.18-1.18-1.18-.82-.82 1-2z"
          fill="#ed1c24"
        />
        <path
          d="m18 30-1 2-3 1-.7-2.8 2.7-1.2z"
          fill="#1a6fb0"
        />
        <path
          d="m17.82 32.82-1.82 8.18h-9v-4.1a6 6 0 0 1 3.56-5.48l2.74-1.22.7 2.8 3-1z"
          fill="#1e81ce"
        />
        <path
          d="m17 5.09v5.91h-5a5.47 5.47 0 0 1 .09-1 5.992 5.992 0 0 1 4.91-4.91z"
          fill="#ff9811"
        />
        <path
          d="m22 26v3l-2 1h-2l-2-1v-3z"
          fill="#ffc477"
        />
        <g fill="#ffb655">
          <path d="m13 17v4h-2a2 2 0 0 1 0-4z" />
          <path d="m29 19a2.006 2.006 0 0 1 -2 2h-2v-4h2a2.006 2.006 0 0 1 2 2z" />
          <path d="m22 26v2.32a6.958 6.958 0 0 1 -6 0v-2.32z" />
        </g>
        <path
          d="m26 17v3a5.474 5.474 0 0 1 -.08 1 6.952 6.952 0 0 1 -3.92 5.32 6.982 6.982 0 0 1 -9.92-5.32 5.474 5.474 0 0 1 -.08-1v-5h14z"
          fill="#ffc477"
        />
        <path
          d="m12 15h14v2h-14z"
...
export default memo(ProjectManagementIcon);
