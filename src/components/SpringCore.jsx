...
import v1 from '@/data/spring-core.v1.1.js';
import {dependency, path} from '@/data/spring-core.const.js';
import v2 from '@/data/spring-core.v1.2.js';
import v3 from '@/data/spring-core.v1.3.js';
